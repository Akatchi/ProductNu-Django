"""
Django settings for productnu project.
...
SECRET_KEY = '3lcid5#ezz58i$j9^a!unqdrci9rr*oi=e-62mjt)yng^oj*if'
...
# Sensible settings for celeryapp
...
# Set redis as celeryapp result backend
